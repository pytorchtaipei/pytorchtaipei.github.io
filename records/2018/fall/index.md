...
| 11/08          | **MobileNet**                           <br>[![][p]][mbnp]{:target="_blank"} [      ][mbnc]{:target="_blank"} [      ][mbnm]{:target="_blank"}      | 郭宗賢               | **Deep Feedforward Networks**           <br>[![][p]][m5p]{:target="_blank"} [      ][m5c]{:target="_blank"} [      ][m5m]{:target="_blank"}  | 陳彥吉 |
...
| ????          | **Gradient Descent & Momentum**         <br>BGD, SGD, Mini-batch GD, NAG[      ][]{:target="_blank"} [      ][]{:target="_blank"} [      ][]{:target="_blank"}    | 缺                   |
<!-- 12/27 -->
<!-- 1/3,10,17,24,31 -->
