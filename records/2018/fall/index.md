...
| 11/01          | **Gradient Descent & Momentum**         <br>BGD, SGD, Mini-batch GD, NAG[      ][gdmp]{:target="_blank"} [      ][gdmc]{:target="_blank"} [      ][gdmm]{:target="_blank"}    | 缺                   | **Machine Learning Basics II**          <br>[![][p]][m4p]{:target="_blank"} [!][m4m]{:target="_blank"}     | 陳彥吉                 |
